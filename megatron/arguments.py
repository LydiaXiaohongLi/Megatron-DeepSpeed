...
def _add_training_args(parser):
    ...
    group.add_argument('--optimizer', type=str, default='adam',
                       choices=['adam', 'sgd', 'lionw', 'adalrlion', 'cliplion'],
    ...
    group.add_argument('--use-rotary-position-embeddings', action='store_true', help='Use rotary position embeddings')
    group.add_argument('--rotary-percent', type=float, default=None)  # TODO
    group.add_argument('--use-alibi-position-embeddings', action='store_true', help='Use alibi position embeddings')
